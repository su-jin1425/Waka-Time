...
if __name__ == "__main__":
    ...
    # Calculate positions for three splits in the top half of the screen
    split_width = screen_width // 3
    y_position = int(screen_height * 0.25)  # Higher up, around 25% from the top

    positions = [
        (split_width // 2, y_position),  # Center of the first split
        (split_width + split_width // 2, y_position),  # Center of the second split
        (2 * split_width + split_width // 2, y_position)  # Center of the third split
    ]
